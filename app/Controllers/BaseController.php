...
class BaseController extends Controller
{
	...
	public function __construct()
	{
		...
		$this->data['scripts'] = array(
			$this->config->baseURL . '/public/assets/vendors/jquery/jquery.min.js', $this->config->baseURL . '/public/assets/vendors/flatpickr/flatpickr.js', $this->config->baseURL . '/public/themes/modern/assets/js/site.js?r=' . time(), $this->config->baseURL . '/public/assets/vendors/zenscroll/zenscroll-min.js', $this->config->baseURL . '/public/assets/vendors/bootstrap/js/bootstrap.js'
		);
	...
	protected function view($file, $data = false, $shared_view = false)
	{
		if (is_array($file)) {
			...
			if ($shared_view) {
				$path = 'shared/themes/modern/';
			} else {
				$path = 'App\Modules\\' . $module['name'] . '\Views\\';
			}
			echo view('shared/themes/modern/header.php', $data);
			echo view($path . $file, $data);
			echo view('shared/themes/modern/footer.php');
		}
	}
