...
class App extends BaseConfig
{
	...
	*/
	...
	// public $baseURL = 'https://khairilanwar.web.id/demo/admin-template-ci4/';
	public $baseURL = 'http://192.168.20.23/sicovidhmvc/';
	public $imagesPath = ROOTPATH . 'public/images/';
	// public $imagesURL = 'https://khairilanwar.web.id/demo/admin-template-ci4/public/images/';
	public $imagesURL = 'http://192.168.20.23/sicovidhmvc/public/images/';
