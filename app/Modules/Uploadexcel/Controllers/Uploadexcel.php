<?php 
namespace App\Modules\Uploadexcel\Controllers;
use App\Modules\Uploadexcel\Models\UploadExcelModel;

class UploadExcel extends \App\Controllers\BaseController
{
	protected $model;
