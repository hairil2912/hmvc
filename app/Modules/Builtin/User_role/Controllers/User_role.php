...
namespace App\Modules\Builtin\User_role\Controllers;

use App\Modules\Builtin\User_role\Models\UserRoleModel;
...
class User_role extends \App\Controllers\BaseController
{
	...
	public function index()
	{
		...
		$this->view('user-role-data.php', $data);
	}
	...
	public function checkbox()
	{
		...
		echo view('App\Modules\Builtin\User_role\Views\user-role-form-edit.php', $this->data);
	}
