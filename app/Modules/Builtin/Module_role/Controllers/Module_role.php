...
namespace App\Modules\Builtin\Module_role\Controllers;

use App\Modules\Builtin\Module_role\Models\ModuleRoleModel;
...
class Module_role extends \App\Controllers\BaseController
{
	...
	public function index()
	{
		...
		$this->view('module-role-data.php', $data);
	}
	...
	public function edit()
	{
		...
		$this->view('module-role-form-add.php', $data);
	}
	...
	public function detail()
	{
		...
		$this->view('module-role-detail.php', $data);
	}
