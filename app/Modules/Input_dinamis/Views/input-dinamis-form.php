					...
					?>
						<div class="form-group row">
							<div class="col-sm-12 form-inline clearfix">
								<?=$options?>
								<input class="form-control" type="text" placeholder="Gelar Depan" name="gelar_depan[]" size="4" value="<?=set_value('gelar_depan['.$key.']', '')?>" placeholder=""/>
								...
								<input class="form-control" type="text" size="8" placeholder="Gelar Belakang" name="gelar_belakang[]" value="<?=set_value('gelar_belakang['.$key.']', '')?>" placeholder=""/>
								<?php
