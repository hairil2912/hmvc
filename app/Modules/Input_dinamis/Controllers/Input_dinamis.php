...
namespace App\Modules\Input_dinamis\Controllers;

use App\Modules\Input_dinamis\Models\InputDinamisModel;
...
class Input_dinamis extends \App\Controllers\BaseController
{
	...
	public function index()
	{
		...
		$this->view('input-dinamis-result.php', $data);
	}
	...
	public function add()
	{
		...
		$this->view('input-dinamis-form.php', $data);
	}
