...
{
	protected $model = '';
	private $viewsPath = 'App\Modules\Register\Views\\';
	...
	public function __construct()
	{
		...
		$this->addJs($this->config->baseURL . 'public/vendors/jquery/jquery-3.3.1.min.js');
	...
	public function index()
	{
		...
		$this->view([$this->viewsPath . 'header.php', $this->viewsPath . $page_content, $this->viewsPath . 'footer.php'], $this->data);
	}
	...
	public function confirm()
	{
		...
		$this->data['message'] = $message;
		$this->view([$this->viewsPath . 'header.php', $this->viewsPath . 'show_message.php', $this->viewsPath . 'footer.php'], $this->data);
	}
