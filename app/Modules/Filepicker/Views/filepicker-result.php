				...
				<nav class="nav-util">
					<div class="form-group form-inline toolbox-bar">
						<div class="toolbox-left"' . $display . '>
							...
							<button class="btn btn-outline-secondary btn-select-files"><i class="far fa-check-square mr-2"></i>Select Files</button>
							<button class="btn btn-outline-secondary btn-cancel-select-files" style="display:none"><i class="fas fa-arrow-circle-left mr-2"></i>Cancel</button>
							<button class="btn btn-outline-danger btn-delete-checked disabled" style="display:none" disabled><i class="fas fa-trash-alt mr-2"></i><span class="text">Delete Checked</span><span class="num-files"></span></button>
							<button class="btn btn-danger btn-delete-all"><i class="fas fa-trash-alt mr-2"></i>Hapus Semua Data</button>
							
							
						</div>
						<div class="toolbox-right">
							<button class="btn btn-success btn-upload-files"><i class="far fa-check-square mr-2"></i>Upload Files</button>
						</div>
					</div>
				</nav>
				<hr/>';
